    ...
    public function print(Request $request, $id)
    {
        ...
        $html = "
                    ...
                    <body>
                        ...
                        <p style='position: absolute;right:60px;top:92px;'>Tanggal / Jam: " . date_format($reservation->created_at, 'd-m-Y h:m')  . "</p>
                        ...
                        <table>
                            ...
                            <tr>
                                <td style='width: 120px;padding: 0;padding-bottom: 4px;'>Status</td>
                                <td style='width: 32px;padding: 0;padding-bottom: 4px;'>:</td>
                                <td style='font-weight: bold;padding: 0;padding-bottom: 4px;'>" . $reservation->status . "</td>
                            </tr>
                        </table>
