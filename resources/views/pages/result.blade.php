        ...
        <div class="col-12 col-md-8">
              ...
              <div class="mb-4">
                ...
                <table class="table table-borderless table-responsive">
                  ...
                  <tr class="mb-2">
                    ...
                    <td class="px-0 py-0 pl-3 font-weight-semibold text-success" style="font-size: 24px;">
                      : Rp. {{ $total_price }}
                    </td>
                  </tr>
                </table>
          ...
          <div class="row mt-4 mt-md-5">
            ...
            <div class="col-12 col-md-8 order-1 order-md-2">
              <a href="{{ route('result.print', ['id' => $reservation->id]) }}"
                class="btn btn-success btn-lg w-100 mb-2 mb-md-0">
                CETAK BUKTI
              </a>
            </div>
          </div>
